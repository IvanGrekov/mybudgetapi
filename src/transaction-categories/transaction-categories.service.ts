...
export class TransactionCategoriesService {
    ...
    async create(
        ...
        transactionCategoryTemplate.parent = await this.getParentForNewTransactionCategory({
            parentId,
            userId,
            type,
        });

        transactionCategoryTemplate.order = await this.getNewTransactionCategoryNewOrder(
    ...
    async reorder({ parentNodes }: ReorderTransactionCategoriesDto) {
        ...
        this.validateReorderingTransactionCategories(parentNodes, currentTransactionCategories);
    ...
    private async getParentForNewTransactionCategory({
        ...
        type,
        userId,
    }: IGetParentForNewTransactionCategoryArgs): Promise<TransactionCategory['parent']> {
    ...
    private getReorderingNodeIds(parentNodes: ReorderParentTransactionCategoryDto[]): number[] {
